...
import { GetRestaurantsResponse, IRestaurant } from '@/types/input.type';
import { restaurantList } from '@/TEST_VERILERI/restaurantList';
import { useRestaurantDelete, useRestaurants } from '@/services/restaurant';
...
const TableRestaurantList = () => {
	...
	const deleteMutation = useRestaurantDelete(params);
