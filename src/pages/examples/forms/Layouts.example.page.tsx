				...
				<HeaderLeft>
					<Breadcrumb
						list={[
							...
							{
								...pages.examples.exampleMain.subPages.forms.subPages.layouts,
							},
						]}
					/>
				</HeaderLeft>
			...
			<Container>
				<div className='grid grid-cols-12 gap-4'>
					<ExampleHeaderPartial
						title='Layouts'
						description='Inline admin form layouts with inline labels that guide users effortlessly through each field.'
					/>
...
export default LayoutsExamplePage;
