...
const SectionFilterBarsExamplePage = () => {
	return (
		<>
			<Header>
				<HeaderLeft>
			...
			<Container>
				<div className='grid grid-cols-12 gap-4'>
					<ExampleHeaderPartial
						title='Section Filter Bars'
						description='Browse Section Filter Bars featuring search bars, dropdowns, date pickers, and sorting options.'
					/>
...
export default SectionFilterBarsExamplePage;
