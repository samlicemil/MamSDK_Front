			...
			<Container>
				<div className='grid grid-cols-12 gap-4'>
					<ExampleHeaderPartial
						title='Date & Time'
						description='Tailwind CSS custom date & time modals with pickers and inputs for seamless scheduling.'
					/>
...
export default DataAndTimeExamplePage;
