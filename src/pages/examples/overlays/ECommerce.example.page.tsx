				...
				<HeaderLeft>
					<Breadcrumb
						list={[
							...
							{
								...pages.examples.exampleMain.subPages.overlays.subPages.eCommerce,
							},
						]}
					/>
				</HeaderLeft>
			...
			<Container>
				<div className='grid grid-cols-12 gap-4'>
					<ExampleHeaderPartial
						title='E-Commerce'
						description='Enhance online shopping experiences with interactive e-commerce modals for promotions, product details, and customer engagement.'
					/>
