				...
				<HeaderLeft>
					<Breadcrumb
						list={[
							...
							{
								...pages.examples.exampleMain.subPages.overlays.subPages.feedback,
							},
						]}
					/>
				</HeaderLeft>
			...
			<Container>
				<div className='grid grid-cols-12 gap-4'>
					<ExampleHeaderPartial
						title='Feedback'
						description='Experience the power of clear alert messages with Feedback Modals.'
					/>
...
export default FeedbackExamplePage;
