			...
			<Container>
				<div className='grid grid-cols-12 gap-4'>
					<ExampleHeaderPartial
						title='Banners'
						description='Discover customizable banners for alerts, promoting custom messages and enhancing customer engagement effectively.'
					/>
...
export default BannersExamplePage;
