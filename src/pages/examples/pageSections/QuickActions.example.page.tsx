...
import quickActionsLargeGroupButtonExampleSource from '@/examples/pageSections/quickActions/QuickActionsLargeGroupButton.example.tsx?raw'; // eslint-disable-line import/extensions

const QuickActionsExamplePage = () => {
	return (
		<>
			<Header>
				<HeaderLeft>
			...
			<Container>
				<div className='grid grid-cols-12 gap-4'>
					<ExampleHeaderPartial
						title='Quick Actions'
						description='Explore colorful and vibrant quick action card blocks.'
					/>

					<ExampleItemPartial
						title='Large Group Button'
						iFrameProps={{ initialWidth: 480 }}
						code={extractSnippetUtil(
							quickActionsLargeGroupButtonExampleSource,
							'quickActionsLargeGroupButtonExampleSource',
						)}>
