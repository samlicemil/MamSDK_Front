			...
			<Container>
				<div className='grid grid-cols-12 gap-4'>
					<ExampleHeaderPartial
						title='Setup Flows'
						description='Tailwind CSS setup flow sections with steps, progress indicators, and forms for guided user onboarding.'
					/>
...
export default SetupFlowsExamplePage;
