			...
			<Container>
				<div className='grid grid-cols-12 gap-4'>
					<div className='col-span-12 flex flex-col items-center justify-center gap-8 py-32'>
						<div className='text-6xl'>Popovers</div>
						<div className='text max-w-5xl text-center text-2xl text-zinc-500'>
							Use Popovers to display additional information or actions in a compact
							overlay triggered by user interaction.
						</div>
					</div>
...
export default PopoversExamplePage;
